...
public class Blog {
    ...
    public void setDisplayBase64(String displayBase64) {
        this.displayBase64 = displayBase64;
    }

    public Blog(int id, String title, String filename, Admin admin, int isTop, int isOriginal, Tag tag, int visitCount, int commentsCount, byte[] displayImage, Date issueDate, String displayBase64, String description) {
        this.id = id;
        this.title = title;
    ...
    public String getDisplayBase64() {
